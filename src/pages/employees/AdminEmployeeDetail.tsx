...
export default function AdminEmployeeDetail() {
  ...
  if (isLoading) {
    return <PageLoader message="Accessing Secure Admin Records..." />;
  }

  if (!employee) {
    return <div className="p-12 text-center text-gray-500 font-medium">Admin employee record not found.</div>;
  }
      ...
      <div className="min-h-[400px] animate-fade-in">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-8">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-gray-800 font-medium">{employee.company || "Admin"}</p>
                            </div>
                            <div className="space-y-1">
              ...
              return (
                <div key={idx} className="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden flex flex-col group hover:shadow-md transition-all">
                  ...
                  <div className="p-4 bg-gray-50/50 flex gap-2">
                       ...
                       <button 
                         onClick={() => navigate(`/admin-employees/edit/${employee.id}?step=2`)}
        ...
        {activeTab === "activity" && (
          <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-12 text-center text-gray-400">
            ...
            <p className="text-sm">Activity tracking for this admin employee will appear here.</p>
          </div>
        )}
      </div>
                    ...
                    {previewDoc.fileUrl ? (
                        ...
                        <div className="p-12 text-center h-full flex flex-col items-center justify-center">
                            ...
                            <p className="text-gray-500 max-w-sm mb-8 leading-relaxed text-sm">
                                ...
                                Please edit the admin employee to attach a document.
                            </p>
                        </div>
                    )}
                </div>
